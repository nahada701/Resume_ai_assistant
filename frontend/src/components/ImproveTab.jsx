...
export default function ImproveTab({ resumeText }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      <div className="card">
        <div style={{ fontWeight: 700, fontSize: 16, marginBottom: 4 }}>AI Section Rewriter</div>
        <div style={{ color: '#718096', fontSize: 13, marginBottom: 16 }}>Paste any section and get an AI-powered rewrite with stronger language, quantified achievements, and ATS optimization.</div>

        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 12 }}>
          <div>
            <label style={{ fontSize: 12, fontWeight: 600, color: '#a0aec0', display: 'block', marginBottom: 6 }}>Section Type</label>
        ...
        <div style={{ marginBottom: 12 }}>
          <label style={{ fontSize: 12, fontWeight: 600, color: '#a0aec0', display: 'block', marginBottom: 6 }}>Original Content</label>
          <textarea className="input" value={content} onChange={e => setContent(e.target.value)}
            placeholder="Paste the section you want to improve..." style={{ minHeight: 140 }} />
        </div>
      ...
      {(text || loading) && (
        <div className="card fade-in">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
            <div style={{ fontWeight: 600, color: '#7f9cf5' }}>Improved Version</div>
            {text && (
          ...
          <div style={{ whiteSpace: 'pre-wrap', fontSize: 14, lineHeight: 1.7, color: '#e2e8f0' }} className={loading ? 'typing-cursor' : ''}>
